module SimulationInterface 
    ...
    mutable struct SimulationInterfaceNode <: Hg.Node 
        ...
        function SimulationInterfaceNode(imu_pub_ip::String, imu_pub_port::String,
    ...
    function Hg.compute(node::SimulationInterfaceNode)
    ...
    function main(; rate=100.0)
        ...
        node = SimulationInterfaceNode(imu_pub_ip, imu_pub_port,
